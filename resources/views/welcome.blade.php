...
<body class="min-h-screen bg-white dark:bg-zinc-900">
    ...
    <header class="sticky top-0 z-10 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/80">
        <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
            ...
            <nav class="hidden items-center gap-6 text-sm font-medium text-zinc-600 md:flex dark:text-zinc-300">
                <a href="#kako-funkcionise" class="hover:text-zinc-900 dark:hover:text-white">Kako funkcioniše</a>
                <a href="#sta-dobijate" class="hover:text-zinc-900 dark:hover:text-white">Šta dobijate</a>
                <a href="#za-koga-je" class="hover:text-zinc-900 dark:hover:text-white">Za koga je</a>
            </nav>
            ...
            @if (Route::has('login'))
                <div class="flex items-center gap-2">
                    ...
                    @else
                        ...
                        {{-- TODO: point to the public /brzi-audit flow once that feature ships; registration is a temporary stand-in entry point. --}}
    ...
    <footer class="border-t border-zinc-100 py-8 dark:border-zinc-800">
        <div class="mx-auto max-w-7xl px-6 text-sm text-zinc-400">
